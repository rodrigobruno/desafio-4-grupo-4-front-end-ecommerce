            ...
            <Container fluid='lg'>
                <Row className='mb-5'>
                    ...
                    >
                        ...
                        <p>
                            A Gama Zone é uma loja especializada em board games
                            que oferece uma experiência única para entusiastas
                            de jogos de tabuleiro. Possui uma ampla variedade de
                            títulos, desde clássicos aos lançamentos.
                        </p>
                    </Col>
                    <Col
                        md={{ span: 4, offset: 0 }}
                    ...
                    >
                        ...
                        <NavLinkRodape to='/produtos'>Produtos</NavLinkRodape>
                        <NavLinkRodape to='/categorias'>
                            Categorias
                        </NavLinkRodape>
                        <NavLinkRodape to='/carrinho'>Carrinho</NavLinkRodape>
                        <NavLinkRodape to='/entrar'>Entrar</NavLinkRodape>
                        <NavLinkRodape to='/cadastrar'>Cadastrar</NavLinkRodape>
                    </Col>
                    <Col
                        md={4}
                        xl={2}
